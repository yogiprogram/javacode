...
public class DoubleSlice {
	public int solution(int[] A) {
		...
		int maxEnding = 0;
		int maxSlice = 0;
		// stores the sum value of max slice of A[1] A[2] ... A[i] in
		// maxSliceLeft[i]
		...
		// stores the sum value of max slice of A[N-2] A[N-1] ... A[i] in
		// maxSliceRight[i]
	...
	public static void main(String[] args) {
		...
		System.out.println(new DoubleSlice().solution(A));
	}
}
